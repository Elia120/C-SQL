...
namespace SSES3
{
    public static class SecurityRepository
    {
        ...
        /// <param name="to"></param>
        /// <returns></returns>
        public static IQueryable<DoorsDeatail> GetSuspiciousActivity(DateTime from, DateTime to)
        {
            throw new NotImplementedException();
        }
        ...
        public static void GrantAccess(int doorId, IEnumerable<Credential> credentials)
        {
            throw new NotImplementedException();
        }
        ...
        public static void LogAuthorizationAttempt(int doorId, IEnumerable<Credential> credentials, bool result)
        {
            throw new NotImplementedException();
        }
